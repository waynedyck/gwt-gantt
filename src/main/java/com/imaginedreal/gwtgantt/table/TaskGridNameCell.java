...
//    }
        ...
        @Override
        public boolean isEditing(Context context, Element element, Task value) {
                ViewData viewData = getViewData(context.getKey());
                return viewData == null ? false : viewData.isEditing();
        }

        @Override
        public void onBrowserEvent(Context context, Element parent, Task value,
...
//                              }
        ...
        @Override
        public boolean resetFocus(Context context, Element parent, Task value) {
         ...
         *            the current value
         */
        private void cancel(Context context, Element parent, Task value) {
         ...
         */
        private void commit(Context context, Element parent, ViewData viewData, ValueUpdater<Task> valueUpdater) {
