...
import com.imaginedreal.gwtgantt.table.TaskGridNameCell1.TaskGridNameCellDetails;
...
public abstract class TaskGridNameCell1 extends AbstractEditableCell<TaskGridNameCellDetails, TaskGridNameCell1.ViewData> {
    ...
    public class TaskGridNameCellDetails {
        ...
        @Override
        public boolean isEditing(Context context, Element element, TaskGridNameCellDetails value) {
                ViewData viewData = getViewData(context.getKey());
                return viewData == null ? false : viewData.isEditing();
        }

        @Override
        public void onBrowserEvent(Context context, Element parent, TaskGridNameCellDetails value,
...
//                              }
        ...
        @Override
        public void render(Context context, TaskGridNameCellDetails value,SafeHtmlBuilder sb) {
                // Get the view data.
                ViewData viewData = getViewData(context.getKey());
        ...
        @Override
        public boolean resetFocus(Context context, Element parent, TaskGridNameCellDetails value) {
         ...
         *            the current value
         */
        private void cancel(Context context, Element parent, TaskGridNameCellDetails value) {
